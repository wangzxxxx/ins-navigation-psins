...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round42_scaleblock_p6_ultrarefine3.py'
OUTPUT_JSON = RESULTS_DIR / 'R42_42state_gm1_round42_scaleblock_p6_ultrarefine3_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r42', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r42_scaleblock_p6_ultrarefine3', str(METHOD_FILE))
