...
METHOD = ROOT / 'psins_method_bench' / 'methods' / 'markov' / 'method_42state_gm1_round22_lever_conditioned_weaksolve.py'
SRC = ROOT / 'tmp_psins_py' / 'psins_py' / 'test_calibration_markov_pruned.py'
OUT = ROOT / 'psins_method_bench' / 'results' / 'R22_markov_42state_gm1_round22_lever_conditioned_weaksolve_param_errors.json'
...
meth = load(METHOD, 'meth_R22')
src = load(SRC, 'src_R22')
res = meth.run_method()
clbt = res[0]
...
payload={'method':'R22_markov_42state_gm1_round22_lever_conditioned_weaksolve','summary':summary,'rows':rows}
