...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round57_internalized_xyzz_yyka_state12_guard.py'
OUTPUT_JSON = RESULTS_DIR / 'R57_42state_gm1_round57_internalized_xyzz_yyka_state12_guard_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r57', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r57_internalized_xyzz_yyka_state12_guard', str(METHOD_FILE))
