...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round49_internalized_iterfeedback_stable.py'
OUTPUT_JSON = RESULTS_DIR / 'R49_42state_gm1_round49_internalized_iterfeedback_stable_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r49', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r49_internalized_iterfeedback_stable', str(METHOD_FILE))
