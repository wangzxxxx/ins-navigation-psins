...
OUT_PNG = OUT_DIR / 'fig_dualpath_pure_scd_custom_noise_0p3_mc50_2026-04-13.png'
OUT_SVG = OUT_DIR / 'fig_dualpath_pure_scd_custom_noise_0p3_mc50_2026-04-13.svg'
...
def make_figure(payload: dict):
    ...
    axes[0].set_title('pure-SCD24 MC50 roll stability (noise ×0.3)')
    ...
    axes[1].set_title('pure-SCD24 MC50 pitch stability (noise ×0.3)')
    ...
    axes[2].set_title('pure-SCD24 MC50 yaw tail (noise ×0.3)')
    ...
    axes[3].set_title('pure-SCD24 MC50 norm distribution (noise ×0.3)')
