...
METHOD = ROOT / 'psins_method_bench' / 'methods' / 'markov' / 'method_42state_gm1_round8_soft_dkgxx_ka2_anchor.py'
SRC = ROOT / 'tmp_psins_py' / 'psins_py' / 'test_calibration_markov_pruned.py'
OUT = ROOT / 'psins_method_bench' / 'results' / 'R8_markov_42state_gm1_round8_soft_dkgxx_ka2_anchor_param_errors.json'
...
OUT.write_text(json.dumps({'method':'R8_markov_42state_gm1_round8_soft_dkgxx_ka2_anchor','summary':summary,'rows':rows}, ensure_ascii=False, indent=2))
