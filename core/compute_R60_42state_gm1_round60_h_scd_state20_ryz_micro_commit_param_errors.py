...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round60_h_scd_state20_ryz_micro_commit.py'
OUTPUT_JSON = RESULTS_DIR / 'R60_42state_gm1_round60_h_scd_state20_ryz_micro_commit_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r60', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r60_h_scd_state20_ryz_micro_commit', str(METHOD_FILE))
