...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round61_h_scd_state20_microtight_commit.py'
OUTPUT_JSON = RESULTS_DIR / 'R61_42state_gm1_round61_h_scd_state20_microtight_commit_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r61', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r61_h_scd_state20_microtight_commit', str(METHOD_FILE))
