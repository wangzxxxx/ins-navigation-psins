...
OUT_JSON = RESULTS_DIR / 'dualpath_pure_scd_custom_noise_0p3_mc50_2026-04-13.json'
OUT_MD = REPORTS_DIR / 'psins_dualpath_pure_scd_custom_noise_0p3_mc50_2026-04-13.md'
...
def run_seed(seed: int) -> dict[str, Any]:
    ...
    cfg_scd24 = pure.h24.Hybrid24Config(
        name='g4_scd_rotation_custom_noise_0p3_mc50',
...
def build_markdown(payload: dict[str, Any]) -> str:
    ...
    lines = [
        '# PSINS 双轴 24-state + pure-SCD 在 0.3× 噪声口径下的 MC50 重复性实验（2026-04-13）',
        '',
...
def main() -> None:
    ...
    payload = {
        'task': 'dualpath_pure_scd_custom_noise_0p3_mc50_2026_04_13',
