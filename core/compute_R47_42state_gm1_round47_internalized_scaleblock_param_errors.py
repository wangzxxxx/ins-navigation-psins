...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round47_internalized_scaleblock.py'
OUTPUT_JSON = RESULTS_DIR / 'R47_42state_gm1_round47_internalized_scaleblock_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r47', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r47_internalized_scaleblock', str(METHOD_FILE))
