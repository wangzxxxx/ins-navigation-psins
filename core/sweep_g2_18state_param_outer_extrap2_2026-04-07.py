...
REF_JSON = WORKSPACE / 'psins_method_bench' / 'results' / 'sweep_g2_18state_param_outer_extrap_2026-04-07.json'
RESULTS_DIR = WORKSPACE / 'psins_method_bench' / 'results'
REPORTS_DIR = WORKSPACE / 'reports'
OUT_JSON = RESULTS_DIR / 'sweep_g2_18state_param_outer_extrap2_2026-04-07.json'
OUT_MD = REPORTS_DIR / 'psins_g2_18state_param_outer_extrap2_2026-04-07.md'
...
CONFIGS = [
    {'label': 'param_outer_fb14_it8', 'feedback_scale': 1.4, 'outer_iterations': 8},
    {'label': 'param_outer_fb16_it8', 'feedback_scale': 1.6, 'outer_iterations': 8},
    {'label': 'param_outer_fb14_it9', 'feedback_scale': 1.4, 'outer_iterations': 9},
    {'label': 'param_outer_fb16_it9', 'feedback_scale': 1.6, 'outer_iterations': 9},
]
...
def main():
    ...
    payload = {
        'task': 'sweep_g2_18state_param_outer_extrap2_2026_04_07',
    ...
    lines = []
    lines.append('# G2 18-state param-outer extrap sweep 2 (2026-04-07)')
    lines.append('')
    lines.append('## 最优配置')
    lines.append('')
