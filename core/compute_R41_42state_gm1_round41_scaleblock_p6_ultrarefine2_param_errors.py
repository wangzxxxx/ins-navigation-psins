...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round41_scaleblock_p6_ultrarefine2.py'
OUTPUT_JSON = RESULTS_DIR / 'R41_42state_gm1_round41_scaleblock_p6_ultrarefine2_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r41', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r41_scaleblock_p6_ultrarefine2', str(METHOD_FILE))
