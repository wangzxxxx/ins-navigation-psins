...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round56_internalized_xyzz_yyka_micro_guard.py'
OUTPUT_JSON = RESULTS_DIR / 'R56_42state_gm1_round56_internalized_xyzz_yyka_micro_guard_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r56', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r56_internalized_xyzz_yyka_micro_guard', str(METHOD_FILE))
