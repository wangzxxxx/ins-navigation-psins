...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round58_llm_guided_alpha12_lever_plus.py'
OUTPUT_JSON = RESULTS_DIR / 'R58_42state_gm1_round58_llm_guided_alpha12_lever_plus_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r58', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r58_llm_guided_alpha12_lever_plus', str(METHOD_FILE))
