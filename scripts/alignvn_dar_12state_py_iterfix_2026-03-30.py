...
- fix the over-aggressive iterative wash strategy discovered on 2026-03-30
- keep the continuous dual-axis rotation trajectory
- produce a runnable improved result + markdown/json summary
"""
...
SCRIPT_PATH = WORKSPACE / 'scripts' / 'alignvn_dar_12state_py_iterfix_2026-03-30.py'
OUT_DIR = WORKSPACE / 'tmp' / 'alignment_strategy_sweep'
OUT_JSON = OUT_DIR / 'alignvn_dar_12state_py_iterfix_result_2026-03-30.json'
OUT_MD = OUT_DIR / 'alignvn_dar_12state_py_iterfix_summary_2026-03-30.md'
...
def alignvn_12state_iter(
    ...
    """Improved iterative DAR aligner.

    Key fix versus the first port:
    - do NOT full-wash the same raw imu every round
    - do carry the attitude seed forward between rounds
    """
    imu_corr = imu.copy()
