...
METHOD = '42-state GM1 round42 selective scale-block P6 + ultra-small guard refinement v3'
FAMILY = 'pruned_markov'
VARIANT = '42state_gm1_round42_scaleblock_p6_ultrarefine3'
...
ROUND41_BASELINE = {
    'rx_y_guard_mult': 1.0392,
    'ry_z_guard_mult': 1.0022,
}

ULTRA_SMALL_CANDIDATES = [
    {'name': 'U1_rx_plus_5e-5', 'rx_y_guard_mult': 1.03925, 'ry_z_guard_mult': 1.00220},
    {'name': 'U2_ry_plus_5e-5', 'rx_y_guard_mult': 1.03920, 'ry_z_guard_mult': 1.00225},
    {'name': 'U3_paired_plus_5e-5', 'rx_y_guard_mult': 1.03925, 'ry_z_guard_mult': 1.00225},
    {'name': 'U4_paired_plus_1e-4', 'rx_y_guard_mult': 1.03930, 'ry_z_guard_mult': 1.00230},
]
...
def _apply_selective_feedback(mod, base_clbt, xk):
    ...
    return refined, xfb, {
        'rx_y_guard': {
            ...
            'delta_vs_round41_mult': float(RX_Y_GUARD_MULT - ROUND41_BASELINE['rx_y_guard_mult']),
        },
        'ry_z_guard': {
            'target_axis': 'ry_z',
            'mode': 'post_scale_multiplicative_guard',
            ...
            'delta_vs_round41_mult': float(RY_Z_GUARD_MULT - ROUND41_BASELINE['ry_z_guard_mult']),
        },
    }


def run_method():
    mod = load_module('markov_pruned_42_round42_scaleblock_p6_ultrarefine3', str(TMP_PSINS / SOURCE))
    ...
    return refined_clbt, base_res[1], base_res[2], base_res[3], {
        ...
        'round41_baseline': ROUND41_BASELINE,
        ...
        'micro_refinement': 'Round41 scale-block P6 preserved exactly; only ultra-small post-scale guard multipliers were nudged within +0.00010 max around the Round41 baseline, including one very light paired-guard candidate that stayed on the same mainline.',
