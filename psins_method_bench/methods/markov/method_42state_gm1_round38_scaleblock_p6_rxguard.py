...
METHOD = '42-state GM1 round38 selective scale-block P6 + light rx_y guard'
FAMILY = 'pruned_markov'
VARIANT = '42state_gm1_round38_scaleblock_p6_rxguard'
...
def run_method():
    mod = load_module('markov_pruned_42_round38_scaleblock_p6_rxguard', str(TMP_PSINS / SOURCE))
    ...
    return refined_clbt, base_res[1], base_res[2], base_res[3], {
        ...
        'rx_y_guard': guard_meta,
        'policy': 'Selective Kg/Ka main-block feedback only, plus a light post-scale rx_y multiplicative guard; eb/db/Ka2/other lever states unchanged.',
    }
