...
METHOD = '42-state GM1 round41 selective scale-block P6 + ultra-small guard refinement v2'
FAMILY = 'pruned_markov'
VARIANT = '42state_gm1_round41_scaleblock_p6_ultrarefine2'
...
ROUND40_BASELINE = {
    'rx_y_guard_mult': 1.0390,
    'ry_z_guard_mult': 1.0020,
}

ULTRA_SMALL_CANDIDATES = [
    {'name': 'C1', 'rx_y_guard_mult': 1.0391, 'ry_z_guard_mult': 1.0020},
    {'name': 'C2', 'rx_y_guard_mult': 1.0390, 'ry_z_guard_mult': 1.0021},
    {'name': 'C3', 'rx_y_guard_mult': 1.0391, 'ry_z_guard_mult': 1.0021},
    {'name': 'C4', 'rx_y_guard_mult': 1.0392, 'ry_z_guard_mult': 1.0022},
]
...
def _apply_selective_feedback(mod, base_clbt, xk):
    ...
    return refined, xfb, {
        'rx_y_guard': {
            ...
            'delta_vs_round40_mult': float(RX_Y_GUARD_MULT - ROUND40_BASELINE['rx_y_guard_mult']),
        },
        'ry_z_guard': {
            'target_axis': 'ry_z',
            'mode': 'post_scale_multiplicative_guard',
            ...
            'delta_vs_round40_mult': float(RY_Z_GUARD_MULT - ROUND40_BASELINE['ry_z_guard_mult']),
        },
    }


def run_method():
    mod = load_module('markov_pruned_42_round41_scaleblock_p6_ultrarefine2', str(TMP_PSINS / SOURCE))
    ...
    return refined_clbt, base_res[1], base_res[2], base_res[3], {
        ...
        'round40_baseline': ROUND40_BASELINE,
        ...
        'micro_refinement': 'Round40 scale-block P6 preserved exactly; only ultra-small post-scale guard multipliers were adjusted upward by +0.0002 on rx_y and +0.0002 on ry_z at most across the tried set.',
