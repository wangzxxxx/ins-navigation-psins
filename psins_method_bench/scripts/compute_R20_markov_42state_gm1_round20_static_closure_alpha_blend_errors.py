...
METHOD = ROOT / 'psins_method_bench' / 'methods' / 'markov' / 'method_42state_gm1_round20_static_closure_alpha_blend.py'
SRC = ROOT / 'tmp_psins_py' / 'psins_py' / 'test_calibration_markov_pruned.py'
OUT = ROOT / 'psins_method_bench' / 'results' / 'R20_markov_42state_gm1_round20_static_closure_alpha_blend_param_errors.json'
...
meth = load(METHOD, 'meth_R20')
src = load(SRC, 'src_R20')
res = meth.run_method()
clbt = res[0]
...
payload={'method':'R20_markov_42state_gm1_round20_static_closure_alpha_blend','summary':summary,'rows':rows}
