...
OUT_PNG = OUT_DIR / 'fig_dualpath_pure_scd_custom_noise_0p4_mc50_sigma_2026-04-13.png'
OUT_SVG = OUT_DIR / 'fig_dualpath_pure_scd_custom_noise_0p4_mc50_sigma_2026-04-13.svg'
...
def make_figure(payload: dict):
    ...
    fig.suptitle('Dual-axis pure-SCD24 @ noise ×0.4: MC50 signed-error and norm distributions', fontsize=13)
