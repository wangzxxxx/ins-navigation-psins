...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round43_scaleblock_reprofile.py'
OUTPUT_JSON = RESULTS_DIR / 'R43_42state_gm1_round43_scaleblock_reprofile_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r43', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r43_scaleblock_reprofile', str(METHOD_FILE))
