...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round46_scaleblock_reprofile4.py'
OUTPUT_JSON = RESULTS_DIR / 'R46_42state_gm1_round46_scaleblock_reprofile4_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r46', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r46_scaleblock_reprofile4', str(METHOD_FILE))
