...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round40_scaleblock_p6_ultrarefine.py'
OUTPUT_JSON = RESULTS_DIR / 'R40_42state_gm1_round40_scaleblock_p6_ultrarefine_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r40', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r40_scaleblock_p6_ultrarefine', str(METHOD_FILE))
