...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round38_scaleblock_p6_rxguard.py'
OUTPUT_JSON = RESULTS_DIR / 'R38_42state_gm1_round38_scaleblock_p6_rxguard_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r38', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r38_scaleblock_p6_rxguard', str(METHOD_FILE))
