...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round45_scaleblock_reprofile3.py'
OUTPUT_JSON = RESULTS_DIR / 'R45_42state_gm1_round45_scaleblock_reprofile3_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r45', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r45_scaleblock_reprofile3', str(METHOD_FILE))
