...
REF_JSON = WORKSPACE / 'psins_method_bench' / 'results' / 'probe_g2_18state_param_outer_singleaxis_2026-04-07.json'
RESULTS_DIR = WORKSPACE / 'psins_method_bench' / 'results'
REPORTS_DIR = WORKSPACE / 'reports'
OUT_JSON = RESULTS_DIR / 'sweep_g2_18state_param_outer_small_2026-04-07.json'
OUT_MD = REPORTS_DIR / 'psins_g2_18state_param_outer_small_2026-04-07.md'
...
CONFIGS = [
    {'label': 'param_outer_fb08_it3', 'feedback_scale': 0.8, 'outer_iterations': 3},
    {'label': 'param_outer_fb10_it3', 'feedback_scale': 1.0, 'outer_iterations': 3},
    {'label': 'param_outer_fb12_it3', 'feedback_scale': 1.2, 'outer_iterations': 3},
    {'label': 'param_outer_fb08_it4', 'feedback_scale': 0.8, 'outer_iterations': 4},
    {'label': 'param_outer_fb10_it4', 'feedback_scale': 1.0, 'outer_iterations': 4},
    {'label': 'param_outer_fb12_it4', 'feedback_scale': 1.2, 'outer_iterations': 4},
    {'label': 'param_outer_fb08_it5', 'feedback_scale': 0.8, 'outer_iterations': 5},
    {'label': 'param_outer_fb10_it5', 'feedback_scale': 1.0, 'outer_iterations': 5},
    {'label': 'param_outer_fb12_it5', 'feedback_scale': 1.2, 'outer_iterations': 5},
]
...
def main():
    ...
    payload = {
        'task': 'sweep_g2_18state_param_outer_small_2026_04_07',
    ...
    lines = []
    lines.append('# G2 18-state param-outer small sweep (2026-04-07)')
    lines.append('')
    lines.append('## 最优配置')
    lines.append('')
