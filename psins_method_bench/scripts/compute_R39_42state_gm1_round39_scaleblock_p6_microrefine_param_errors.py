...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round39_scaleblock_p6_microrefine.py'
OUTPUT_JSON = RESULTS_DIR / 'R39_42state_gm1_round39_scaleblock_p6_microrefine_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r39', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r39_scaleblock_p6_microrefine', str(METHOD_FILE))
