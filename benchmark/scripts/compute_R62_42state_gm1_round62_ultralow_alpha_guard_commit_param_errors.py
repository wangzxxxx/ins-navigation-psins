...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round62_ultralow_alpha_guard_commit.py'
OUTPUT_JSON = RESULTS_DIR / 'R62_42state_gm1_round62_ultralow_alpha_guard_commit_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r62', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r62_ultralow_alpha_guard_commit', str(METHOD_FILE))
