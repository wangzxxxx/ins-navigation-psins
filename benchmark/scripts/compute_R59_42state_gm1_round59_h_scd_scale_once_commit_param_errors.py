...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round59_h_scd_scale_once_commit.py'
OUTPUT_JSON = RESULTS_DIR / 'R59_42state_gm1_round59_h_scd_scale_once_commit_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r59_h', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r59_h_scd_scale_once_commit', str(METHOD_FILE))
