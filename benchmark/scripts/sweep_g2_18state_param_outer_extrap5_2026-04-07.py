...
REF_JSON = WORKSPACE / 'psins_method_bench' / 'results' / 'sweep_g2_18state_param_outer_extrap4_2026-04-07.json'
RESULTS_DIR = WORKSPACE / 'psins_method_bench' / 'results'
REPORTS_DIR = WORKSPACE / 'reports'
OUT_JSON = RESULTS_DIR / 'sweep_g2_18state_param_outer_extrap5_2026-04-07.json'
OUT_MD = REPORTS_DIR / 'psins_g2_18state_param_outer_extrap5_2026-04-07.md'
...
CONFIGS = [
    {'label': 'param_outer_fb22_it14', 'feedback_scale': 2.2, 'outer_iterations': 14},
    {'label': 'param_outer_fb24_it14', 'feedback_scale': 2.4, 'outer_iterations': 14},
    {'label': 'param_outer_fb22_it15', 'feedback_scale': 2.2, 'outer_iterations': 15},
    {'label': 'param_outer_fb24_it15', 'feedback_scale': 2.4, 'outer_iterations': 15},
]
...
def main():
    ...
    payload = {
        'task': 'sweep_g2_18state_param_outer_extrap5_2026_04_07',
    ...
    lines = []
    lines.append('# G2 18-state param-outer extrap sweep 5 (2026-04-07)')
    lines.append('')
    lines.append('## 最优配置')
    lines.append('')
