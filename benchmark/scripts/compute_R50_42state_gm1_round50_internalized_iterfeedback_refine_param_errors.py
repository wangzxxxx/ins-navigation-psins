...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round50_internalized_iterfeedback_refine.py'
OUTPUT_JSON = RESULTS_DIR / 'R50_42state_gm1_round50_internalized_iterfeedback_refine_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r50', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r50_internalized_iterfeedback_refine', str(METHOD_FILE))
    ...
    print('__RESULT_JSON__=' + json.dumps({
        ...
        'lever_guard_pct': lever_guard_pct,
        'overall': overall,
        'candidate_key': extra.get('candidate_key'),
