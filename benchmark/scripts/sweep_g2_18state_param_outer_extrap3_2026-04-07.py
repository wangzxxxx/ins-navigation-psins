...
REF_JSON = WORKSPACE / 'psins_method_bench' / 'results' / 'sweep_g2_18state_param_outer_extrap2_2026-04-07.json'
RESULTS_DIR = WORKSPACE / 'psins_method_bench' / 'results'
REPORTS_DIR = WORKSPACE / 'reports'
OUT_JSON = RESULTS_DIR / 'sweep_g2_18state_param_outer_extrap3_2026-04-07.json'
OUT_MD = REPORTS_DIR / 'psins_g2_18state_param_outer_extrap3_2026-04-07.md'
...
CONFIGS = [
    {'label': 'param_outer_fb16_it10', 'feedback_scale': 1.6, 'outer_iterations': 10},
    {'label': 'param_outer_fb18_it10', 'feedback_scale': 1.8, 'outer_iterations': 10},
    {'label': 'param_outer_fb16_it11', 'feedback_scale': 1.6, 'outer_iterations': 11},
    {'label': 'param_outer_fb18_it11', 'feedback_scale': 1.8, 'outer_iterations': 11},
]
...
def main():
    ...
    payload = {
        'task': 'sweep_g2_18state_param_outer_extrap3_2026_04_07',
    ...
    lines = []
    lines.append('# G2 18-state param-outer extrap sweep 3 (2026-04-07)')
    lines.append('')
    lines.append('## 最优配置')
    lines.append('')
