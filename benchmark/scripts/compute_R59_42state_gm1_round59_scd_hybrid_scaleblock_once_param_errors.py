...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round59_scd_hybrid_scaleblock_once.py'
OUTPUT_JSON = RESULTS_DIR / 'R59_42state_gm1_round59_scd_hybrid_scaleblock_once_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r59', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r59_scd_hybrid_scaleblock_once', str(METHOD_FILE))
