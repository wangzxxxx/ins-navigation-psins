...
METHOD = ROOT / 'psins_method_bench' / 'methods' / 'markov' / 'method_42state_gm1_staged_qr_schedule.py'
SRC = ROOT / 'tmp_psins_py' / 'psins_py' / 'test_calibration_markov_pruned.py'
OUT = ROOT / 'psins_method_bench' / 'results' / 'R3_markov_42state_gm1_staged_qr_schedule_param_errors.json'
...
OUT.write_text(json.dumps({'method':'R3_markov_42state_gm1_staged_qr_schedule','summary':summary,'rows':rows}, ensure_ascii=False, indent=2))
