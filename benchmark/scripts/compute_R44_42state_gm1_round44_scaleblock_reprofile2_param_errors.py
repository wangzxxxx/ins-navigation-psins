...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round44_scaleblock_reprofile2.py'
OUTPUT_JSON = RESULTS_DIR / 'R44_42state_gm1_round44_scaleblock_reprofile2_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r44', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r44_scaleblock_reprofile2', str(METHOD_FILE))
