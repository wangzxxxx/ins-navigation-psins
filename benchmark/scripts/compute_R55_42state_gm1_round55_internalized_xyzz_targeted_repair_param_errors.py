...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round55_internalized_xyzz_targeted_repair.py'
OUTPUT_JSON = RESULTS_DIR / 'R55_42state_gm1_round55_internalized_xyzz_targeted_repair_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r55', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r55_internalized_xyzz_targeted_repair', str(METHOD_FILE))
