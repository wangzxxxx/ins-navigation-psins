...
METHOD_FILE = METHOD_DIR / 'method_42state_gm1_round53_internalized_trustcov_release.py'
OUTPUT_JSON = RESULTS_DIR / 'R53_42state_gm1_round53_internalized_trustcov_release_param_errors.json'
...
def main():
    ...
    source_mod = load_module('markov_pruned_source_for_r53', str(SOURCE_FILE))
    method_mod = load_module('markov_method_r53_internalized_trustcov_release', str(METHOD_FILE))
