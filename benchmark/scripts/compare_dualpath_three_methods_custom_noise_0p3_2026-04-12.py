...
OUT_JSON = RESULTS_DIR / 'compare_dualpath_three_methods_custom_noise_0p3_2026-04-12.json'
OUT_MD = REPORTS_DIR / 'psins_dualpath_three_methods_custom_noise_0p3_2026-04-12.md'
...
def load_base12():
    global _BASE12
    if _BASE12 is None:
        _BASE12 = load_module('dualpath_custom_noise_0p3_base12_20260412', BASE12_PATH)
    return _BASE12
...
def load_h24():
    global _H24
    if _H24 is None:
        _H24 = load_module('dualpath_custom_noise_0p3_h24_20260412', H24_PATH)
    return _H24
...
def load_scale18():
    global _SCALE18
    if _SCALE18 is None:
        _SCALE18 = load_module('dualpath_custom_noise_0p3_scale18_20260412', SCALE18_PATH)
    return _SCALE18
...
def load_pure_scd():
    ...
    if _PURE_SCD is None:
        _PURE_SCD = load_module('dualpath_custom_noise_0p3_pure_scd_20260412', PURE_SCD_PATH)
    return _PURE_SCD
...
def build_markdown(payload: dict[str, Any]) -> str:
    ...
    lines = [
        '# PSINS 双轴三方法自对准自定义噪声×0.3重跑（2026-04-12）',
        '',
...
def main() -> None:
    ...
    payload = {
        'task': 'compare_dualpath_three_methods_custom_noise_0p3_2026_04_12',
