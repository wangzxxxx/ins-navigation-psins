...
METHOD = '42-state GM1 weak delayed release'
FAMILY = 'pruned_markov'
VARIANT = '42state_gm1_weak_delayed_release'


def run_method():
    mod = load_module('markov_pruned_42_weak_delayed_release', str(TMP_PSINS / SOURCE))
    ts = 0.01
    ...
    for it in range(iterations):
        print(f'  [42-GM1-WEAK-DELAY] Iter {it+1}/{iterations}')
        ...
        if it != iterations - 1:
            ...
            scale = 0.2 if it == 0 else 0.5
            kf['xk'][27:36] = kf['xk'][27:36] * scale
