...
METHOD = '42-state GM1 round29 dominant-axis trust-matched lever subblock solve'
FAMILY = 'pruned_markov'
VARIANT = '42state_gm1_round29_dominantaxis_trustmatch'
...
def _dominantaxis_trustmatch_refine(mod, imu1, pos0, ts, strong_clbt):
    eth = mod.Earth(pos0)
    ...
    delta_sigma = mod.np.array([0.00385, 0.0027, 0.0027, 0.00385, 0.0027, 0.0027])
...
def run_method():
    mod = load_module('markov_pruned_42_round29_dominantaxis_trustmatch', str(TMP_PSINS / SOURCE))
    ...
    base_res = mod.run_calibration(
        ...
        label='42-GM1-R29-BASE'
    )
    refined_clbt, extra = _dominantaxis_trustmatch_refine(mod, imu_noisy, pos0, ts, base_res[0])
