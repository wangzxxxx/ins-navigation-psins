...
METHOD = '42-state GM1 (SCD-noise baseline)'
FAMILY = 'pruned_markov'
VARIANT = '42state_gm1_scdnoise'


def run_method():
    mod = load_module('markov_pruned_42_scdnoise', str(TMP_PSINS / SOURCE))
    ts = 0.01
    ...
    # Match the SCD/noisy_baseline dataset noise settings for fair baseline comparison.
