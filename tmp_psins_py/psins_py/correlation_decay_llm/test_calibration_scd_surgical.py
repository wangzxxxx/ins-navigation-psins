                ...
                if is_static:
                    ...
                    if scd_mode and scd_params and not scd_applied_this_phase:
                        if time_since_rot_stop >= scd_params['transition_duration']:
                            ...
                            # db (9:12) and Ka2 (27:30) are physically indistinguishable at static attitudes.
                            # Cutting their covariance breaks the filter. We MUST restore their physical bond.
                            P[9:12, 27:30] /= a_sf
                            P[27:30, 9:12] /= a_sf
